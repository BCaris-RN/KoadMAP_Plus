...
void main() {
  testWidgets('renders splash access gate by default', (
    WidgetTester tester,
  ) async {
    ...
    expect(find.text('Log in to the workspace'), findsOneWidget);
    expect(find.text('Log in and continue'), findsOneWidget);
  });

  testWidgets('renders workspace when a session is present', (
    WidgetTester tester,
  ) async {
